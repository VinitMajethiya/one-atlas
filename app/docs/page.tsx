    ...
    'cli-setup': {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="relative bg-dark-navy text-gray-200 p-5 rounded-2xl font-mono text-xs md:text-sm shadow-inner group">
            <button
    ...
    'schemas': {
      ...
      content: (
        <div className="space-y-6">
          ...
          <div className="relative bg-dark-navy text-gray-200 p-5 rounded-2xl font-mono text-xs md:text-sm shadow-inner">
            <button
